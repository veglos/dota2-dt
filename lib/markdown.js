...
Respond ONLY in Spanish and ONLY with these 5 sections and exact headings:
1. ## ✅ Que hice bien
2. ## ❌ Que hice mal
3. ## 🛠️ Que puedo mejorar
4. ## 🧰 Analisis breve de items comprados
5. ## 🏆 Principal responsable de la victoria (if win) OR ## ⚠️ Principal responsable de la derrota (if loss)

Rules:
- Use hero NAMES from this report, never hero IDs.
- Be concrete and concise.
- In section 3, include 3 actionable improvements.
- In section 3, do not use bold formatting in the heading.
- In section 4, give a brief itemization critique for my hero.
- In section 4, if possible, mention one not-purchased item that would have been better and why.
- In section 5, use exactly this heading if the team won: "## 🏆 Principal responsable de la victoria".
- In section 5, use exactly this heading if the team lost: "## ⚠️ Principal responsable de la derrota".
